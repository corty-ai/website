        ...
        <section className="py-20 relative">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6 font-space">
              Get in touch with
              <span className="gradient-text block">the Corty team</span>
            </h1>
            <p className="text-xl text-gray-400 mb-8 leading-relaxed">
              We'd love to hear from you. Whether you're interested in our platform, 
              have questions, or want to explore partnerships, we're here to help.
            </p>
          </div>
        </section>
            ...
            <div className="relative bg-gradient-to-r from-red-900/20 via-pink-900/20 to-violet-900/20 rounded-3xl p-10 border border-red-500/20 backdrop-blur-sm">
              ...
              <div className="relative text-center">
                ...
                <p className="text-gray-400 mb-8 leading-relaxed">
                  For all inquiries, partnerships, early access requests, or general questions, 
                ...
                <div className="bg-gray-900/50 rounded-2xl p-8 border border-gray-800/50 mb-8">
                  <div className="flex items-center justify-center space-x-3 mb-4">
                    ...
                    <span className="text-lg font-semibold text-white font-space">Email Us</span>
                  </div>
                  <a 
        ...
        <section className="py-20 bg-gray-900/20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-white mb-4 font-space">Frequently Asked Questions</h2>
            ...
            <div className="space-y-6">
              <div className="bg-gray-900/50 rounded-2xl p-6 border border-gray-800/50">
                ...
                <p className="text-gray-400 leading-relaxed">
                  We're currently in development and building towards our initial release. 
                  Contact us at support@corty.dev to join our early access program and be 
                  among the first to experience our AI-powered code intelligence platform.
                </p>
              </div>
              ...
              <div className="bg-gray-900/50 rounded-2xl p-6 border border-gray-800/50">
                ...
                <p className="text-gray-400 leading-relaxed">
                  Corty combines symbolic AI, RAG-powered search, and agentic capabilities 
                  to provide true code intelligence that understands context, relationships, 
                  and organizational knowledge across distributed repositories and enterprise environments.
                </p>
              </div>
              ...
              <div className="bg-gray-900/50 rounded-2xl p-6 border border-gray-800/50">
                ...
                <p className="text-gray-400 leading-relaxed">
                  Yes, we're building Corty with enterprise needs in mind, including on-premise 
                  deployment, data sovereignty, security compliance, and integration with existing 
                  development workflows. Contact us to discuss your specific requirements.
                </p>
              </div>
            </div>
          </div>
