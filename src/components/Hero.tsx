    ...
    <section className="relative min-h-screen bg-black overflow-hidden flex items-start pt-24">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10 w-full">
        ...
        <p className="text-base lg:text-lg text-gray-500 mb-16 max-w-3xl mx-auto leading-relaxed">
          We're building the future of code intelligence. Unify your organization's code and knowledge with Corty's multi-repo, AI-powered context engine. 
          Transform how your team navigates, understands, and collaborates on complex codebases.
        </p>
        
        {/* Vision Stats */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20 max-w-4xl mx-auto">
          <div className="text-center">
            <div className="text-3xl font-bold text-white mb-2 font-space">10x</div>
            <div className="text-sm text-gray-400">Faster code discovery</div>
          </div>
          <div className="text-center">
            <div className="text-xl font-bold text-white mb-2 font-space">Symbolic AI</div>
            <div className="text-sm text-gray-400">Powered intelligence</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-white mb-2 font-space">∞</div>
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto text-left">
            <div className="bg-gray-900/30 rounded-xl p-6 border border-gray-800/50">
              <h3 className="text-white font-semibold mb-2 font-space">Distributed Repository Challenges</h3>
              <p className="text-gray-400 text-sm">Current AI code agents struggle with enterprise environments where repositories are distributed across multiple systems and organizational boundaries, limiting their effectiveness.</p>
            </div>
            <div className="bg-gray-900/30 rounded-xl p-6 border border-gray-800/50">
              <h3 className="text-white font-semibold mb-2 font-space">Third-Party Code Integration</h3>
              <p className="text-gray-400 text-sm">Enterprise applications typically build upon extensive third-party libraries and frameworks, requiring comprehensive indexing and seamless integration with proprietary codebases.</p>
            </div>
            <div className="bg-gray-900/30 rounded-xl p-6 border border-gray-800/50">
              <h3 className="text-white font-semibold mb-2 font-space">Enterprise Security Requirements</h3>
              <p className="text-gray-400 text-sm">Organizations require on-premise deployment solutions that maintain complete data sovereignty and comply with strict security protocols without external code sharing.</p>
            </div>
          </div>
        </div>
      </div>
