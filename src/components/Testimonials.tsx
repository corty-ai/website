...
const Testimonials = () => {
  const testimonials = [
    {
      quote: "Corty has completely transformed how our team onboards new developers. What used to take weeks now takes days.",
      author: "Sarah Chen",
    ...
    {
      quote: "The AI-powered search is incredible. I can find any piece of code across our 50+ microservices in seconds.",
    ...
    {
      quote: "The code intelligence features have helped us reduce technical debt by 40% and catch potential issues before they hit production.",
      author: "Emily Watson",
      role: "Tech Lead",
      company: "GitHub",
      avatar: "https://images.pexels.com/photos/762020/pexels-photo-762020.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop&crop=face",
      rating: 5
    }
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 opacity-40 hover:opacity-60 transition-opacity duration-500">
            {['Stripe', 'Shopify', 'GitHub', 'Netflix', 'Airbnb', 'Uber', 'Dropbox', 'Slack'].map((company) => (
              <div key={company} className="text-lg font-bold text-gray-400 hover:text-gray-300 transition-colors font-space">
                {company}
              </div>
            ))}
          </div>
